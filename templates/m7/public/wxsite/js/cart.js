	  ...
	  if(datas.flag == false){    
    	...
    	var temp_htmls = '';
		 ...
		 if(datas.content.bagcost != 0){
       	  	  temp_htmls = '     <li><span class="shopdetalistL">服务费</span><span class="shopdetalistC">&nbsp;</span><span class="shopdetalistR">￥'+datas.content.bagcost+'</span></li>    ';
			  $('#shocart').append(temp_htmls); 
		 }
...
function ShowChangezuo(){
	$('body').append('<div id="mask" style="" ></div>'); //创建遮照层
	$('body').append('<div class="popup w580" style="display:none;"><div class="popup-hd"><a id="closex" title="关闭" class="closex closegb" href="javascript:void(0);"><span>关闭</span></a></div><p id="alertbox-msg" class="position02">请选择你是直接预订车位还是下单预订</p><div class="bgPray" style="display: -webkit-box;display: -moz-box;display: -o-box;display: box;-webkit-box-align: center;-moz-box-align: center;-o-box-align: center;box-align: center;"><div style="width:50%;"><input id="alertbox-OK" class="inputBtn05 dogozuo" type="button" value="预定车位"></div><div style="width:50%;"><input id="alertbox-OK" class="inputBtn05 closegb" type="button" value="购卡"></div></div></div>');
  $('.popup').slideToggle();
  $('.dogozuo').bind("click", function() {   
