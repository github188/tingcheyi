...
function firstPage() {
    ...
    $("#mc0").animate({ right: '10%' }, 3000, function () {
        $(this).find("img").css({ "background": "url('./templates/m7/public/site/arrowr.png') no-repeat", "background-position": "right center" });
    });
}
...
function changeNav(c) {
    ...
    if (tc > 0 && tc < 5) {
        tc = 1;
        $(".w_hd").css("background", "url(./templates/m7/public/site/hd_icon" + c + ".png) no-repeat");
    } else {
    ...
    for (var i = 0; i < 6; i++) {
        if (tc == i) {
            $("#menu" + i).attr("src", "./templates/m7/public/site/" + menuNameArr[i] + "_hover.gif");
        } else {
            $("#menu" + i).attr("src", "./templates/m7/public/site/" + menuNameArr[i] + ".gif");
        }
    }
    /*mapping animate*/
    toMainAnimate(c);
...
function animateE1(c) {
    ...
    $("#mb" + c).animate({ 'top': '28%', 'opacity': '1', 'filter': 'alpha(opacity=1)', '-moz-opacity': '1' }, 1000);
    ...
    $("#search").css("background-color","#46A4E4");
}
function animateE2(c) {
    ...
    $("#mc" + c).animate({ right: '20%' }, 3000, function () {
       ...
       $("#search").css("background-color","#FF59A8");
}
function animateE3(c) {
    ...
    $("#mc" + c).animate({ right: '20%' }, 3000, function () {
        $(this).find("img").css({ "background": "url('./templates/m7/public/site/arrowr.png') no-repeat", "background-position": "right center" });
         ...
         $("#search").css("background-color","#FFB751");
}
function animateE4(c) {
    ...
    $("#mc" + c).animate({ right: '20%' }, 3000, function () {
        $(this).find("img").css({ "background": "url('./templates/m7/public/site/arrowr.png') no-repeat", "background-position": "right center" });
             ...
             $("#search").css("background-color","#01DCB6");
}
